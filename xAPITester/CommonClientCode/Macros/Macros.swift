...
//      _log.msg("Malformed macro condition - \(condition)", level: .error, function: #function, file: #file, line: #line)
      ...
      _log.msg("Malformed macro condition - \(condition)", level: MessageLevel.error, function: #function, file: #file, line: #line)
...
//        _log.msg("Macro error: slice - \(number)", level: .error, function: #function, file: #file, line: #line)
        ...
        _log.msg("Macro error: slice - \(String(number))", level: MessageLevel.error, function: #function, file: #file, line: #line)
...
//        _log.msg("Macro error: panadapter - \(number)", level: .error, function: #function, file: #file, line: #line)
        ...
        _log.msg("Macro error: panadapter - \(String(number))", level: MessageLevel.error, function: #function, file: #file, line: #line)
...
//      _log.msg("Macro error: object - \(object)", level: .error, function: #function, file: #file, line: #line)
      ...
      _log.msg("Macro error: object - \(String(object))", level: MessageLevel.error, function: #function, file: #file, line: #line)
...
//        _log.msg("Macro error: slice param - \(p)", level: .error, function: #function, file: #file, line: #line)
        ...
        _log.msg("Macro error: slice param - \(String(p))", level: MessageLevel.error, function: #function, file: #file, line: #line)
        return nil
      }
...
//        _log.msg("Macro error: panadapter param - \(p)", level: .error, function: #function, file: #file, line: #line)
        ...
        _log.msg("Macro error: panadapter param - \(String(p))", level: MessageLevel.error, function: #function, file: #file, line: #line)
        return nil
      }
    }
    return nil
